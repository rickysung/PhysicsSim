...
public:
    ...
    OwnedArray<ModelObject> modelObjects;
...
private:
    ...
    static ModelObject* parseFaceGroup (const Mesh& srcMesh,
                                  ...
                                  const String& name)
    {
        ...
        ScopedPointer<ModelObject> modelObject (new ModelObject());
        ...
        for (int i = 0; i < faceGroup.size(); ++i)
            faceGroup.getReference(i).addIndices (modelObject->mesh, srcMesh, indexMap);
